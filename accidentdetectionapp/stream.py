...
def send_notification(id,flag):
    pusher_client = pusher.Pusher(
     app_id='1658349',
  key='92ac27b541ab3b5c4c16',
  secret='b99990ca462961b863c8',
  cluster='ap2',
  ssl=True
    )
    if flag:
...
def detect(boxes,t1):
    ...
    return False
def send_message():
    client = vonage.Client(key="2d2389c8", secret="b5VhUEi44vFjIrl9")
    sms = vonage.Sms(client)
    responseData = sms.send_message(
        {
            "from": "Vonage APIs",
            "to": "918897718767",
            "text": "Urgent \n Accident happened at Hyd. Please send ambulance as soon as possible. Google map link :- https://www.google.com/maps/search/?api=1&query=47.5%2C-122.3316393 ",
        }
    )
...
def sendmail():
    ...
    gmail_list.append("mahendergoli712@gmail.com")
    print("gmail list",gmail_list)
    email_subject = "Urgent please send ambulance."
    email_body = "Accident happened at Gurunanak Institutions,Khanapur please send ambulance as soon as possible. Google map link :- https://www.google.com/maps/search/Guru+Nanak+Institutions/@17.3092444,78.4150712,11z/data=!3m1!4b1?entry=ttu "
...
class streaming(object):
    def __init__(self):
        ...
        self.model1=torch.hub.load('ultralytics/yolov5', 'custom', path='C:\\Users\\mahen\\OneDrive\\Documents\\C Language\\workshop\\OSDHack-22_AccidentDetectionAI-main\\OSDHack-22_AccidentDetectionAI-main\\best (2).pt',device='cpu')
        self.model = torch.hub.load('ultralytics/yolov5', 'custom', path='C:\\Users\\mahen\\OneDrive\\Documents\\C Language\\workshop\\OSDHack-22_AccidentDetectionAI-main\\OSDHack-22_AccidentDetectionAI-main\\best (2).pt',device='cpu')
